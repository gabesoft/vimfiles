...
syntax case ignore
syntax include @javaHtml <sfile>:p:h/java.html.vim
...
syn region javaFuncDef start="^\z(\s*\)\(\(public\|protected\|private\|static\|abstract\|final\|native\|synchronized\)[ \n]\+\)*\(void\|String\|String\[\]\|String\[\]\[\]\|boolean\|boolean\[\]\|boolean\[\]\[\]\|char\|char\[\]\|char\[\]\[\]\|byte\|byte\[\]\|byte\[\]\[\]\|short\|short\[\]\|short\[\]\[\]\|int\|int\[\]\|int\[\]\[\]\|long\|long\[\]\|long\[\]\[\]\|float\|float\[\]\|float\[\]\[\]\|double\|double\[\]\|double\[\]\[\]\|\([A-Z][A-Za-z0-9_]*\)\)[ \n]\+[a-z][A-Za-z0-9_]*[ \n]*(\_[^)]*)[ \n]*\(\<throws\>[ \n]\+[A-Z]\w\+\([ \n]*,[ \n]*[A-Z]\w\+\)*[ \n]*\)\?{" end="^\z1}$" keepend transparent fold
