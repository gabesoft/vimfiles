" vim cheat sheet (some commands are custom to my vimrc)
" ------------------------------------------------------------------------------
...
" objects
" ------------------------------------------------------------------------------
" editing command structure: <number><command:change/delete/yank><object or motion>
...
" - ap : a paragraph
" - ip : inner paragraph
" - aa : function argument (with plugin)
" - ai : inner argument (with plugin)
...
" - a) : a parenthesized block (also available as ab)
" - i) : inner parenthesized block (also available as ib)
" - a] : a bracketed block
" - i] : inner bracketed block
" - a} : a brace block (also available as aB)
" - i} : inner brace block (also available as iB)
" - at : a tag block (html tag)
